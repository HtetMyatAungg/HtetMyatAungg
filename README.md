...
Aspiring Software Engineer and AI Researcher focused on algorithmic efficiency, logic-based agents, and data-driven decision-making. MENSA member. Elected Student Representative for the CS cohort (ISC).
...
> MobileNetV2 transfer learning · 99% validation accuracy · 30+ FPS live webcam inference

- Engineered a tf.data pipeline with AUTOTUNE prefetching across 13,414 images
- Deployed real-time Haar Cascade face detection + MobileNetV2 classification
- Full software lifecycle: data collection → training → evaluation → live deployment
...
- Analysed win-rate gains vs O(n²) computational costs across 1–30 mine densities
...
- Conducted ad-hoc deep dives across demographic and socioeconomic features
- Identified sex as the strongest survival predictor across all variables
...
📍 Egham, United Kingdom · **Open to Summer 2026 internships**
